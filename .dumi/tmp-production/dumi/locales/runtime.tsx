...
import { RawIntlProvider, createIntl, createIntlCache } from 'D:/code/learn/happy-ui/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from 'D:/code/learn/happy-ui/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    const base = "/react-ui-library-tutorial"
